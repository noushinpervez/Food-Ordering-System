...
<body class="sidebar-light">
  <div class="container-scroller">
	...
	<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row fade-in">
      <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
        ...
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.php"><img src="assets/images/i2.png" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="index.php"><img src="assets/images/i2.png" alt="logo"/></a>
        </div>
